...
- `realtime_ndt_scan_matcher/examples/tokio_ndt.rs` — the async reference host over synthetic data (proves the `Host` seam).
- `realtime_ndt_scan_matcher/examples/threads_ndt.rs` — multi-threaded shared-engine usage.
...
> Source: `realtime_ndt_scan_matcher/src/scan_matcher.rs`, `realtime_ndt_scan_matcher/src/host.rs`, `realtime_ndt_scan_matcher/examples/{tokio_ndt,threads_ndt}.rs`, `realtime_ndt_scan_matcher/src/lib.rs`.
