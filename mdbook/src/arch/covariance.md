...
> Source: `realtime_ndt_scan_matcher/src/cov_estimate.rs`, `realtime_ndt_scan_matcher/src/covariance.rs`, `realtime_ndt_scan_matcher/src/engine.rs` (`estimate_covariance`),
> `realtime_ndt_scan_matcher/src/helper.rs` (`rotate_covariance`).
