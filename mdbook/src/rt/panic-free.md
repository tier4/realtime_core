...
note in `realtime_ndt_scan_matcher/Cargo.toml`.
...
> Source: `realtime_ndt_scan_matcher/Cargo.toml` `[lints]`; the workspace root `Cargo.toml`
> `[profile.release]`; `realtime_ndt_scan_matcher/src/ndt.rs`.
