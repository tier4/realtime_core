...
> Source: `realtime_ndt_scan_matcher/src/voxel_grid.rs`, `realtime_ndt_scan_matcher/src/derivatives.rs`, `realtime_ndt_scan_matcher/src/ndt.rs`, `realtime_localization_util/src/transform.rs`
> (`gauss_constants`).
