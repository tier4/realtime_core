...
> Source: `realtime_ndt_scan_matcher/src/convergence.rs`, `realtime_ndt_scan_matcher/src/ndt.rs` (`transformation_probability`,
> `nearest_voxel_transformation_likelihood`, `finalize`), `realtime_ndt_scan_matcher/src/host.rs` (`MatchResult`).
